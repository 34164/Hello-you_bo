...
if (const_answer === "1") {
    ...
    if (bridge_choice === "1") {
        ...
        if (chest_choice === "1") {
            console.log("Je maakt de schatkist open en er springen 100 giftige slangen op je. Oei, je bent dood.");
            ...
            if (winkel_choice === "1") {
                ...
                if (kijken_choice === "1") {
                    console.log("Je gaat naar buiten en ziet 10 kapotte piano's op straat.");
                    console.log("BOEM!!!, er viel nog 1 piano op jou.");
                    ...
                    console.log("Ga je een lot kopen?");
                    console.log("1 (Ja, ik koop een lot)");
                    console.log("2 (Nee, ik koop geen lot)");

                    var lot_choice = rl.question('Wat doe je? ');

                    if (lot_choice === "1") {
                        console.log("Je koopt een lot en krast het open.");
                        console.log("Kies een getal:");
                        console.log("1");
                        console.log("2");
                        ...
                        if (kras_choice === "1") {
                            ...
                            console.log("Gefeliciteerd, je hebt zojuist $100.000 gewonnen!");
                        } else {
                            console.log("Ongeldige keuze voor het krassen.");
                        }
                    } else if (lot_choice === "2") {
                        console.log("Je koopt geen lot en krijgt een berichtje van de bank dat je -$100.000 op de bank hebt staan.");
    ...
    if (temple_choice === "1") {
        ...
        if (struik_choice === "1") {
            console.log("Je loopt naar de struik toe om te kijken wat dat was, O NEE!!! Een tijger springt uit de struiken.");
            console.log("Helaas, de tijger heeft je goed te pakken, je bent dood.");
        } else if (struik_choice === "2") {
            console.log("Je blijft wegrennen, maar oeps, je struikelt. En uit de struiken rent een tijger op je af.");
            console.log("Hij verscheurt je in stukken, helaas, je bent dood.");
        }
    }
