...
if (const_answer === "1") {
    ...
    if (bridge_choice === "1") {
        ...
        if (chest_choice === "1") {
            ...
            }else if (winkel_choice === "2") { 
                console.log("Je gaat niet naar binnen en loopt door, opeens vallen er 10 piano`s op je");
            console.log("Helaas je bent dood.");
                ...
                console.log("Je blijft binnen en ziet dat je krasloten kan gaan kopen.");
  ...
  if (const_answer === "2") {
    ...
    if (cliff_choice === "1") {
        console.log("Je hebt springt over de afgrond , en je haalt nog maar net de rand.");
        ...
        console.log("Je beweegt net optijd naar voren en hebt het overleeft");
        console.log("Je loopt snel door en komt uiteindelijk terecht bij een superrijke veloren stad waar je belastingvrij kan gaan leven");
